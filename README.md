...
| `exclude` | A list of files & folders to exclude from the generated zip file in addition to the [defaults](https://github.com/TryGhost/action-deploy-theme/blob/c34423b8c15e4cf14365e782b47434e9a5efd769/index.js#L28), e.g. `"gulpfile.js *dist/*"` | `string` | No |
